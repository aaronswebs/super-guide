...
This guide will help you get the Azure OpenAI Assistants Chat Bot running in under 10 minutes.
...
> `DefaultAzureCredential`. Ensure your identity has the **Cognitive Services OpenAI Contributor**
> RBAC role on the Azure OpenAI resource. For local dev, sign in via `az login`.
...
**"401 Unauthorized"**
- Ensure your identity has the **Cognitive Services OpenAI Contributor** RBAC role on the Azure OpenAI resource
- Locally, ensure you're signed in via `az login`
...
- [Azure OpenAI Assistants API](https://learn.microsoft.com/en-us/azure/ai-services/openai/how-to/assistant) - Official docs
